...
export const { setUserProjects, addProject, deleteProject, renameProject, addChatToProject, setUserProjectChats, deleteChatFromProject, addPromptToProjectChat } = projectsSlice.actions
